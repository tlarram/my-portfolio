  ...
  return (
    <div id="about" ref={props.about}>
        ...
        <span>Hello! My name is Timothy Larramore, and I am a full stack web developer.  I have a background in education as a teacher and assistant principal.  
            ...
            way to get to know a little about me.  I want to create web projects as a full stack developer.  When I am not coding, I am a simple man.  I enjoy playing video games, reading books, and spending time with my family. </span>
    </div>
  )
}
